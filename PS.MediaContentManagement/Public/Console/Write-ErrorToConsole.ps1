<#
    ...
    and Reset-Console Indent. Always displays red, ignores colour if provided.
    ...
    .EXAMPLE
    PS> Write-ErrorToConsole "Hello"
#>
function Write-ErrorToConsole (
    ...
    Write-ToConsole -ForegroundColor Red @Object -NoNewLine:$NoNewLine
}