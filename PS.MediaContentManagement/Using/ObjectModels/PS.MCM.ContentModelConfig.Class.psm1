...
class ContentModelConfig {
    ...
    [Void] OverrideFilenameFormat ([FilenameElement[]] $filenameFormat) {
        ...
        if ($null -eq $filenameFormat -or $filenameFormat.Count -lt 1) {
            ...
            $this._FilenameFormat = [ModuleSettings]::DEFAULT_FILM_FILENAME_FORMAT()
        }
        else {
    ...
    [Void] OverrideFilenameSplitter ([String] $filenameSplitter) {
        if ($null -eq $filenameSplitter -or $filenameSplitter.Length -lt 1) {
            ...
            $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        }
        else {
    ...
    [Void] OverrideListSplitter ([String] $listSplitter) {
        if ($null -eq $listSplitter -or [String]::IsNullOrEmpty($listSplitter)) {
            ...
            $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        }
        else {
    ...
    [Void] OverrideExportFormat ([ExportableAttribute[]] $exportFormat) {
        if ($null -eq $exportFormat -or $exportFormat.Count -lt 1) {
            ...
            $this._ExportFormat = [ModuleSettings]::DEFAULT_VIDEO_EXPORT_FORMAT()
        }
        else {
    ...
    [Void] ConfigureForUnstructuredFiles () {        
        $this._IncludedExtensions = @()
        $this._DecorateAsTags = @()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_FILE_FILENAME_FORMAT()
        $this._FilenameSplitter = $null
        $this._ListSplitter = $null
        $this._ExportFormat = [ModuleSettings]::DEFAULT_FILES_EXPORT_FORMAT()
    }
    ...
    [Void] ConfigureForFilm () {
        ...
        $this._IncludedExtensions = [ModuleSettings]::DEFAULT_VIDEO_EXTENSIONS()
        $this._DecorateAsTags = [ModuleSettings]::DEFAULT_TAGS()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_FILM_FILENAME_FORMAT()
        $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        $this._ExportFormat = [ModuleSettings]::DEFAULT_VIDEO_EXPORT_FORMAT()
    ...
    [Void] ConfigureForShortFilm () {
        ...
        $this._IncludedExtensions = [ModuleSettings]::DEFAULT_VIDEO_EXTENSIONS()
        $this._DecorateAsTags = [ModuleSettings]::DEFAULT_TAGS()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_SHORTFILM_FILENAME_FORMAT()
        $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        $this._ExportFormat = [ModuleSettings]::DEFAULT_VIDEO_EXPORT_FORMAT()
    }
    ...
    [Void] ConfigureForSeries () {
        ...
        $this._IncludedExtensions = [ModuleSettings]::DEFAULT_VIDEO_EXTENSIONS()
        $this._DecorateAsTags = [ModuleSettings]::DEFAULT_TAGS()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_SERIES_FILENAME_FORMAT()
        $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        $this._ExportFormat = [ModuleSettings]::DEFAULT_VIDEO_EXPORT_FORMAT()
    }
    ...
    [Void] ConfigureForTrack () {
        ...
        $this._IncludedExtensions = [ModuleSettings]::DEFAULT_AUDIO_EXTENSIONS()
        $this._DecorateAsTags = [ModuleSettings]::DEFAULT_TAGS()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_TRACK_FILENAME_FORMAT()
        $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        $this._ExportFormat = [ModuleSettings]::DEFAULT_AUDIO_EXPORT_FORMAT()
    }
    ...
    [Void] ConfigureForAlbumAndTrack () {
        ...
        $this._IncludedExtensions = [ModuleSettings]::DEFAULT_AUDIO_EXTENSIONS()
        $this._DecorateAsTags = [ModuleSettings]::DEFAULT_TAGS()
        $this._FilenameFormat = [ModuleSettings]::DEFAULT_ALBUMANDTRACK_FILENAME_FORMAT()
        $this._FilenameSplitter = [ModuleSettings]::DEFAULT_FILENAME_SPLITTER()
        $this._ListSplitter = [ModuleSettings]::DEFAULT_LIST_SPLITTER()
        $this._ExportFormat = [ModuleSettings]::DEFAULT_AUDIO_EXPORT_FORMAT()
    }
