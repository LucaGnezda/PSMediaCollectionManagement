<#
    ...
    and Reset-Console Indent. Always displays yellow, ignores colour if provided.
    ...
    .EXAMPLE
    PS> Write-WarnToConsole "Hello"
#>
function Write-WarnToConsole (
    ...
    Write-ToConsole -ForegroundColor Yellow @Object -NoNewLine:$NoNewLine
}